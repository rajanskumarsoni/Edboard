            ...
            if (e._execAction("_processClick", 0, arguments), !e._mixing || e.animation.queue && e._queue.length < e.animation.queueLimit) {
                ...
                if ("filter" === d) {
                    var h, i = c.attr("data-filter"),
                        pc = c.parents('#gallery'),
			pc1 = c.parents('#members');
                    	if(pc.length!=0){
                        	if(c.hasClass('active')){
                              	
                            }else{
                              	c.parent().siblings().children().removeClass('active');
                            	c.addClass('active');
                              	if(i!='all'){
                                  	$('#gallery .work-item').css('display','none');
                                	$('#gallery .work-item'+i+'').css('display','block');
                                }else{
                                	$('#gallery .work-item').css('display','block');
                                }
                            }
                        }else if(pc1.length!=0){
                        	if(c.hasClass('active')){
                            	...
                            	c.addClass('active');
                              	if(i!='all'){
                                  	$('#members .work-item').css('display','none');
                                	$('#members .work-item'+i+'').css('display','block');
                                }else{
                                	$('#members .work-item').css('display','block');
                                }
                            }
                        }
